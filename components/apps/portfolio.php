...
<section class="container-wrapper">
  <section class="container">
    ...
    <div class="item item-4">
      ...
      <p class="notes-list-header">iCloud</p>
       <ul class="notes-left-list">
          <li>
            <div>
    ...
    <div class="item item-5" >
      <ul class="notes-project-list">
          <li>
            <h2>Figma Project</h2>
             <div class="project-list-time-desc">
              <p>12:35 PM</p>
              <p>Desinged a product that works</p>                
             </div>
          </li>
          <li>
            <h2>Duolingo Project</h2>
             <div class="project-list-time-desc">
              <p>Yesterday, 9:02 AM</p>
              <p>Finished working on </p>                
             </div>
          </li>
          <li>
            <h2>Personal Website</h2>
             <div class="project-list-time-desc">
              <p>Last week, 9:02AM</p>
              <p>Start the day off </p>                
             </div>
          </li>
          <li>
            <h2>Figma Project</h2>
             <div class="project-list-time-desc">
              <p>Last month, 2:26 PM</p>
              <p>Redesign the</p>                
             </div>
          </li>
          <li>
            <h2>Figma Project</h2>
             <div class="project-list-time-desc">
              <p>2 months ago, 6:23 AM</p>
              <p>Desinged a product that w...</p>                
             </div>
          </li>
        </ul>
    </div>
